...
\usepackage[left=20mm, right=10mm, top=20mm, bottom=20mm, headheight=1.5cm, headsep=0.5cm, footskip=1cm]{geometry} % Пакет geometry с аргументами для определения полей
